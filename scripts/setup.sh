...
sudo sed -i "s/export APACHE_RUN_USER=.*/export APACHE_RUN_USER=$NEW_USER/" /etc/apache2/envvars
sudo sed -i "s/export APACHE_RUN_GROUP=.*/export APACHE_RUN_GROUP=$NEW_GROUP/" /etc/apache2/envvars
